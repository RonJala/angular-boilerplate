...
export class PostService {
  ...
  getPostsByUser(id : number){
    ...
    return of(this.listaPosts.filter(post => post.user_id === id));
  ...
  getPostsByID(id : number){
    ...
    let post = this.listaPosts.find(post => post.id == id);
    console.log(post);
   
    return of(this.listaPosts.find(post => post.id == id));
  ...
  updatePost(id : number, post : Post){
    ...
    this.listaPosts[id].text = post.text;
    this.listaPosts[id].image_url = post.image_url;

    return of(this.listaPosts[id]);
